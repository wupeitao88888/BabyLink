...
public class AsyncHttpClient {
    ...
    private static final int DEFAULT_SOCKET_TIMEOUT = 10 * 1000; // 默认超时时间
    ...
    private int socketTimeout; // 连接对象超时时间
...
*/        threadPool = (ThreadPoolExecutor)Executors.newCachedThreadPool();
    ...
    /**
     * Create a new AsyncHttpClient and set timeout.
     */
    ...
    private String getUrlWithQueryString(String url, RequestParams params) {
        ...
        LogMessage.i("server_url", "完整的请求连接:"+url);
        return url;
    }

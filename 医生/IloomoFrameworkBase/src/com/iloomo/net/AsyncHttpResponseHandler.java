...
public class AsyncHttpResponseHandler {
    ...
    void sendResponseMessage(HttpResponse response) {
        ...
        LogMessage.v("data_server", responseBody!=null?responseBody:"");
        if(status.getStatusCode() >= 300) {
            sendFailureMessage(new HttpResponseException(status.getStatusCode(), status.getReasonPhrase()), "server error"+status.getStatusCode());
        } else {

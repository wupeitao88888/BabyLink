...
import com.iloomo.doctor.hx.MApplication;
...
public class CameraHelper implements PreviewCallback {
    ...
    boolean isScreenOriatationPortrait() {
        return MApplication.applicationContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
